...
SPECTACULAR_SETTINGS = {
    ...
    'TAGS': [
        {'name': 'Authentication', 'description': 'JWT token management and user registration'},
        {'name': 'Tenant', 'description': 'Diagnostic center info (public)'},
        {'name': 'Patients', 'description': 'Patient registration and management (staff/doctor)'},
        {'name': 'Doctors', 'description': 'Doctor management and activity (staff/admin)'},
        {'name': 'Staff', 'description': 'Staff listing (admin)'},
        {'name': 'Appointments', 'description': 'Appointment scheduling and consultation'},
        {'name': 'Test Orders', 'description': 'Lab test prescriptions and queue management'},
        {'name': 'Reports', 'description': 'Lab report creation, verification, and delivery'},
        {'name': 'Payments', 'description': 'Payment recording and tracking'},
        {'name': 'Diagnostics', 'description': 'Test types and center-specific pricing'},
    ],
