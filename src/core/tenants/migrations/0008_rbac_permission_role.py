        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "codename",
                    models.CharField(
                        help_text="Programmatic identifier, e.g. view_reports",
                        max_length=100,
                        unique=True,
                    ),
                ),
                (
                    "name",
                    models.CharField(
                        help_text="Human-readable name, e.g. View Reports",
                        max_length=150,
                    ),
                ),
                (
                    "category",
                    models.CharField(
                        help_text="Grouping category for UI, e.g. Reports",
                        max_length=50,
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="roles", to="tenants.permission"
                    ),
                ),
            ],
            options={
