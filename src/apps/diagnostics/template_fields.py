...
def _copy_fields(test_name):
    return [field.copy() for field in TEMPLATE_FIELDS[test_name]]
...
ADDITIONAL_TEMPLATE_FIELDS = {
    'CBC': _copy_fields('CBC (Complete Blood Count)'),
    'CBC + ESR': _copy_fields('CBC (Complete Blood Count)')
    + [
        {
            'name': 'ESR (Westergren)',
            'unit': 'mm/1st hr',
    ...
    'ECG (12CH)': _copy_fields('ECG (Electrocardiogram)'),
    'ECG (12CH) With Report': _copy_fields('ECG (Electrocardiogram)'),
    'ECG (6CH)': _copy_fields('ECG (Electrocardiogram)'),
    'Echocardiography 2D & M-Mode': _copy_fields('Echocardiography (Echo)'),
    'Echocardiography Color Doppler / 4D M-Mode': _copy_fields(
        'Echocardiography (Echo)'
    ),
    'Endoscopy Upper GIT': [
...
TEMPLATE_FIELDS.update(ADDITIONAL_TEMPLATE_FIELDS)
