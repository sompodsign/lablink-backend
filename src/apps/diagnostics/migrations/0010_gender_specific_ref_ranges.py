...
GENDER_SPECIFIC_FIELDS = {
    "CBC (Complete Blood Count)": [
        ...
        },
        {
            "name": "RBC Count",
            "unit": "million/cumm",
            "ref_range_male": "4.5-5.9",
            "ref_range_female": "3.8-5.2",
            "ref_range_child": "3.9-5.3",
        },
        ...
        {"name": "Platelet Count", "unit": "/cumm", "ref_range": "150000-450000"},
        {
            ...
            "unit": "%",
            "ref_range_male": "38-50",
            "ref_range_female": "36-44",
            "ref_range_child": "33-43",
        },
    ...
    "ESR (Erythrocyte Sedimentation Rate)": [
        {
            ...
            "unit": "mm/1st hr",
            "ref_range_male": "0-15",
            "ref_range_female": "0-20",
            "ref_range_child": "0-10",
        },
    ],
    "Hemoglobin (Hb)": [
        {
    ...
    "Serum Iron": [
        {
            "name": "Serum Iron",
            "unit": "μg/dL",
            "ref_range_male": "65-176",
            "ref_range_female": "50-170",
            "ref_range_child": "50-120",
        },
    ],
    "Serum Ferritin": [
        {
            "name": "Serum Ferritin",
            "unit": "ng/mL",
            "ref_range_male": "12-300",
            "ref_range_female": "12-150",
            "ref_range_child": "7-140",
        },
    ],
    "GGT (Gamma-GT)": [
        {
    ...
    "Testosterone": [
        {
            "name": "Testosterone",
            "unit": "ng/dL",
            "ref_range_male": "270-1070",
            "ref_range_female": "15-70",
        },
    ],
    "Prolactin": [
        {
    ...
    "CPK (Creatine Phosphokinase)": [
        {
            "name": "CPK (Total)",
            "unit": "U/L",
            "ref_range_male": "39-308",
            "ref_range_female": "26-192",
        },
    ],
    "Semen Analysis": [
