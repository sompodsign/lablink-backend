...
TESTS = [
    # ── Hematology ──────────────────────────────────────────────
    ('CBC (Complete Blood Count)', 'Complete blood count including WBC, RBC, Hb, Hct, MCV, MCH, MCHC, Platelet count, and differential count.', 500),
    ...
    ('Peripheral Blood Film (PBF)', 'Microscopic examination of blood smear for morphology.', 400),
    ...
    ('APTT (Activated Partial Thromboplastin Time)', 'Coagulation screening test.', 500),
    ...
    ('Blood Sugar (2hr ABF / PP)', 'Post-prandial blood sugar, 2 hours after meal.', 200),
    ('HbA1c (Glycated Hemoglobin)', '3-month average blood sugar level.', 800),
    ('OGTT (Oral Glucose Tolerance Test)', 'Fasting + 1hr + 2hr glucose after 75g glucose load.', 500),

    # ── Lipid Profile ───────────────────────────────────────────
    ('Lipid Profile', 'Total Cholesterol, HDL, LDL, Triglycerides, VLDL, TC/HDL ratio.', 800),
    ...
    # ── Liver Function ──────────────────────────────────────────
    ('Liver Function Test (LFT)', 'SGPT, SGOT, Bilirubin (Total & Direct), ALP, Total Protein, Albumin, Globulin, A/G Ratio.', 1200),
    ...
    ('Renal Function Test (RFT)', 'Creatinine, BUN, Urea, Uric Acid, Electrolytes.', 1200),
    ...
    ('Beta hCG (Pregnancy Test - Quantitative)', 'Quantitative pregnancy hormone.', 700),
    ...
    ('Malaria (ICT/Rapid)', 'Rapid malaria antigen test (P. falciparum / P. vivax).', 500),
    ('Malaria Parasite (MP) - Smear', 'Thick and thin blood film for malaria parasite.', 300),
    ...
    # ── Urine Tests ─────────────────────────────────────────────
    ('Urine Routine (R/E)', 'Routine urine examination — color, pH, specific gravity, sugar, protein, microscopy.', 200),
    ('Urine Culture & Sensitivity', 'Urine culture with antibiotic sensitivity.', 800),
    ('Urine Microalbumin (ACR)', 'Albumin-creatinine ratio for diabetic kidney screening.', 600),
    ...
    # ── Stool Tests ─────────────────────────────────────────────
    ('Stool Routine (R/E)', 'Routine stool examination — color, consistency, microscopy, OBT.', 200),
    ...
    ('Blood Culture & Sensitivity', 'Aerobic blood culture with antibionic sensitivity.', 1200),
    ...
    ('KOH Mount (Fungal Smear)', 'Potassium hydroxide preparation for fungal elements.', 250),
    ...
    # ── Body Fluid Analysis ─────────────────────────────────────
    ('CSF Analysis', 'Cerebrospinal fluid — cell count, protein, glucose, Gram stain.', 1000),
