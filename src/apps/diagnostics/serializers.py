...
class TestOrderCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if hasattr(request.user, "doctor_profile") and not validated_data.get(
            "referring_doctor_name"
        ):
...
class ReportCreateSerializer(serializers.Serializer):
    ...
    def validate_test_order(self, test_order):
        ...
        if hasattr(test_order, "report"):
            raise serializers.ValidationError("This test order already has a report.")
        return test_order
    ...
    def validate(self, attrs):
        ...
        if test_order:
            ...
            attrs["referring_doctor_name"] = test_order.referring_doctor_name or ""
        else:
