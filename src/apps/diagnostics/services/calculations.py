...
PREDEFINED_FORMULAS = {
    ...
    'LDL Cholesterol': {
        ...
        'calc': lambda vals: (
            vals['Total Cholesterol'] - vals['HDL Cholesterol']
    ...
    'MCHC': {
        ...
        'calc': lambda vals: (
            vals['Hemoglobin'] / vals['Hematocrit'] * Decimal('100')
        ),
        'precision': 1,
    },
    'MCH': {
        ...
        'calc': lambda vals: (
            vals['Hemoglobin'] / vals['RBC Count'] * Decimal('10')
        ),
        'precision': 1,
    },
    'MCV': {
        ...
        'calc': lambda vals: (
            vals['Hematocrit'] / vals['RBC Count'] * Decimal('10')
        ),
        'precision': 1,
    },
    'TC/HDL Ratio': {
...
def auto_calculate(result_data: dict) -> dict:
    ...
    for field_name, formula in PREDEFINED_FORMULAS.items():
        ...
        try:
            ...
            precision = formula.get('precision', 2)
            result_data[field_name]['value'] = str(
                round(calculated, precision)
            )
